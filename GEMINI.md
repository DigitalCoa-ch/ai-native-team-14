...
- **Vercel (The Production Site):** This is where your app is hosted. Vercel watches GitHub; every time OpenClaw pushes code to the `main` branch, Vercel automatically builds and updates your public website at: https://team-14.apps.digitalcoa.ch
...
## 3. WORKFLOW
- **Your URL:** https://ai-native-14.digitalcoa.ch
- **Your Repo:** https://github.com/DigitalCoa-ch/ai-native-team-14
- **Your App:** https://team-14.apps.digitalcoa.ch
